...
def parse_arguments() -> Optional[Config]:
    ...
    parser.add_argument('--services', nargs='+', help='List of services to monitor')
    parser.add_argument('--poll-interval', type=int, help='Polling interval in milliseconds')
    parser.add_argument('--stats-interval', type=int, help='Statistics generation interval in seconds')
    parser.add_argument('--create-config', type=str, help='Create a default configuration file')
